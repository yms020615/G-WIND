...
from forecast_to_xarr import forecast_to_xarr
from gwind import GWIND
import warnings
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="gwind",
        help="Model architecture to train/evaluate (default: gwind)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "set to 0 to disable sanity checking (default: 0)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="Dimensionality of all hidden representations (default: 256)",
    )
    parser.add_argument(
        "--latent_dim",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of Prior layers(default: 4)",
    )
    parser.add_argument(
        "--mesh_aggr",
        type=str,
    ...
    if args.load:
        model = model_class.load_from_checkpoint(args.load, args=args, strict=False)
        if args.restore_opt:
            # Save for later
